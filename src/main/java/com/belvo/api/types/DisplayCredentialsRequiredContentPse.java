...
@JsonDeserialize(
    builder = DisplayCredentialsRequiredContentPse.Builder.class
)
public final class DisplayCredentialsRequiredContentPse {
  private final Optional<PaymentInstitution> payerInstitution;

  private int _cachedHashCode;

  DisplayCredentialsRequiredContentPse(Optional<PaymentInstitution> payerInstitution) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DisplayCredentialsRequiredContentPse && equalTo((DisplayCredentialsRequiredContentPse) other);
  }

  private boolean equalTo(DisplayCredentialsRequiredContentPse other) {
  ...
  public String toString() {
    return "DisplayCredentialsRequiredContentPse{" + "payerInstitution: " + payerInstitution + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(DisplayCredentialsRequiredContentPse other) {
    ...
    public DisplayCredentialsRequiredContentPse build() {
      return new DisplayCredentialsRequiredContentPse(payerInstitution);
    }
  }
}

...
@JsonDeserialize(
    builder = InvoicesPaymentsRelatedDocumentsSat.Builder.class
)
public final class InvoicesPaymentsRelatedDocumentsSat {
  ...
  InvoicesPaymentsRelatedDocumentsSat(Optional<String> invoiceIdentification,
  ...
  /**
   * @return The fiscal institution's unique ID for the related deferred invoice.
   */
  ...
  /**
   * @return The currency of the related invoice. For example:
   * <ul>
   * <li>
  ...
  /**
   * @return The payment method of the related invoice.
   */
  ...
  /**
   * @return The payment installment number.
   */
  ...
  /**
   * @return The invoice amount before the payment.
   */
  ...
  /**
   * @return The amount paid in this installment.
   */
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof InvoicesPaymentsRelatedDocumentsSat && equalTo((InvoicesPaymentsRelatedDocumentsSat) other);
  }

  private boolean equalTo(InvoicesPaymentsRelatedDocumentsSat other) {
  ...
  public String toString() {
    return "InvoicesPaymentsRelatedDocumentsSat{" + "invoiceIdentification: " + invoiceIdentification + ", currency: " + currency + ", paymentMethod: " + paymentMethod + ", partialityNumber: " + partialityNumber + ", previousBalance: " + previousBalance + ", amountPaid: " + amountPaid + ", outstandingBalance: " + outstandingBalance + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(InvoicesPaymentsRelatedDocumentsSat other) {
    ...
    public InvoicesPaymentsRelatedDocumentsSat build() {
      return new InvoicesPaymentsRelatedDocumentsSat(invoiceIdentification, currency, paymentMethod, partialityNumber, previousBalance, amountPaid, outstandingBalance);
    }
  }
}

...
@JsonDeserialize(
    builder = PaymentsTransactionsPaginatedResponse.Builder.class
)
public final class PaymentsTransactionsPaginatedResponse {
  ...
  private final Optional<List<PaymentTransaction>> results;

  private int _cachedHashCode;

  PaymentsTransactionsPaginatedResponse(Optional<Integer> count, Optional<String> next,
      Optional<String> previous, Optional<List<PaymentTransaction>> results) {
    this.count = count;
    this.next = next;
  ...
  public Optional<List<PaymentTransaction>> getResults() {
    return results;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PaymentsTransactionsPaginatedResponse && equalTo((PaymentsTransactionsPaginatedResponse) other);
  }

  private boolean equalTo(PaymentsTransactionsPaginatedResponse other) {
  ...
  public String toString() {
    return "PaymentsTransactionsPaginatedResponse{" + "count: " + count + ", next: " + next + ", previous: " + previous + ", results: " + results + "}";
  }
  ...
  public static final class Builder {
    ...
    private Optional<List<PaymentTransaction>> results = Optional.empty();

    private Builder() {
    }

    public Builder from(PaymentsTransactionsPaginatedResponse other) {
    ...
    public Builder results(Optional<List<PaymentTransaction>> results) {
      this.results = results;
      return this;
    }

    public Builder results(List<PaymentTransaction> results) {
      this.results = Optional.of(results);
      return this;
    }

    public PaymentsTransactionsPaginatedResponse build() {
      return new PaymentsTransactionsPaginatedResponse(count, next, previous, results);
    }
  }
}

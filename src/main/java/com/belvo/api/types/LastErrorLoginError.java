...
@JsonDeserialize(
    builder = LastErrorLoginError.Builder.class
)
public final class LastErrorLoginError {
  ...
  LastErrorLoginError(String errorCode, String errorMessage) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof LastErrorLoginError && equalTo((LastErrorLoginError) other);
  }

  private boolean equalTo(LastErrorLoginError other) {
  ...
  public String toString() {
    return "LastErrorLoginError{" + "errorCode: " + errorCode + ", errorMessage: " + errorMessage + "}";
  }
  ...
  public interface ErrorCodeStage {
    ...
    Builder from(LastErrorLoginError other);
  }
  ...
  public static final class Builder implements ErrorCodeStage, ErrorMessageStage, _FinalStage {
    ...
    @Override
    public Builder from(LastErrorLoginError other) {
    ...
    /**
     * <p>A unique error code (<code>login_error</code>) that allows you to classify and handle the error programmatically.</p>
    ...
    @Override
    public LastErrorLoginError build() {
      return new LastErrorLoginError(errorCode, errorMessage);
    }
  }
}

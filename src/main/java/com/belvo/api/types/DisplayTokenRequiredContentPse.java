...
@JsonDeserialize(
    builder = DisplayTokenRequiredContentPse.Builder.class
)
public final class DisplayTokenRequiredContentPse {
  private final Optional<PaymentInstitution> payerInstitution;

  private int _cachedHashCode;

  DisplayTokenRequiredContentPse(Optional<PaymentInstitution> payerInstitution) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DisplayTokenRequiredContentPse && equalTo((DisplayTokenRequiredContentPse) other);
  }

  private boolean equalTo(DisplayTokenRequiredContentPse other) {
  ...
  public String toString() {
    return "DisplayTokenRequiredContentPse{" + "payerInstitution: " + payerInstitution + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(DisplayTokenRequiredContentPse other) {
    ...
    public DisplayTokenRequiredContentPse build() {
      return new DisplayTokenRequiredContentPse(payerInstitution);
    }
  }
}

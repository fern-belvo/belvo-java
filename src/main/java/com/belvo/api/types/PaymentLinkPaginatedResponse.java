...
@JsonDeserialize(
    builder = PaymentLinkPaginatedResponse.Builder.class
)
public final class PaymentLinkPaginatedResponse {
  ...
  private final Optional<List<PaymentLinkPaginatedResponseResultsItem>> results;

  private int _cachedHashCode;

  PaymentLinkPaginatedResponse(Optional<Integer> count, Optional<String> next,
      Optional<String> previous, Optional<List<PaymentLinkPaginatedResponseResultsItem>> results) {
    this.count = count;
    this.next = next;
  ...
  public Optional<List<PaymentLinkPaginatedResponseResultsItem>> getResults() {
    return results;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PaymentLinkPaginatedResponse && equalTo((PaymentLinkPaginatedResponse) other);
  }

  private boolean equalTo(PaymentLinkPaginatedResponse other) {
  ...
  public String toString() {
    return "PaymentLinkPaginatedResponse{" + "count: " + count + ", next: " + next + ", previous: " + previous + ", results: " + results + "}";
  }
  ...
  public static final class Builder {
    ...
    private Optional<List<PaymentLinkPaginatedResponseResultsItem>> results = Optional.empty();

    private Builder() {
    }

    public Builder from(PaymentLinkPaginatedResponse other) {
    ...
    public Builder results(Optional<List<PaymentLinkPaginatedResponseResultsItem>> results) {
      this.results = results;
      return this;
    }

    public Builder results(List<PaymentLinkPaginatedResponseResultsItem> results) {
      this.results = Optional.of(results);
      return this;
    }

    public PaymentLinkPaginatedResponse build() {
      return new PaymentLinkPaginatedResponse(count, next, previous, results);
    }
  }
}

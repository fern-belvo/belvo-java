...
@JsonDeserialize(
    builder = LastErrorSessionExpired.Builder.class
)
public final class LastErrorSessionExpired {
  ...
  LastErrorSessionExpired(String errorCode, String errorMessage) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof LastErrorSessionExpired && equalTo((LastErrorSessionExpired) other);
  }

  private boolean equalTo(LastErrorSessionExpired other) {
  ...
  public String toString() {
    return "LastErrorSessionExpired{" + "errorCode: " + errorCode + ", errorMessage: " + errorMessage + "}";
  }
  ...
  public interface ErrorCodeStage {
    ...
    Builder from(LastErrorSessionExpired other);
  }
  ...
  public static final class Builder implements ErrorCodeStage, ErrorMessageStage, _FinalStage {
    ...
    @Override
    public Builder from(LastErrorSessionExpired other) {
    ...
    /**
     * <p>A unique error code (<code>session_expired</code>) that allows you to classify and handle the error programmatically.</p>
    ...
    @Override
    public LastErrorSessionExpired build() {
      return new LastErrorSessionExpired(errorCode, errorMessage);
    }
  }
}

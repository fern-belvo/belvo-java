...
@JsonDeserialize(
    builder = CustomerPaginatedResponse.Builder.class
)
public final class CustomerPaginatedResponse {
  ...
  private final Optional<List<CustomerPaginatedResponseResultsItem>> results;

  private int _cachedHashCode;

  CustomerPaginatedResponse(Optional<Integer> count, Optional<String> next,
      Optional<String> previous, Optional<List<CustomerPaginatedResponseResultsItem>> results) {
    this.count = count;
    this.next = next;
  ...
  public Optional<List<CustomerPaginatedResponseResultsItem>> getResults() {
    return results;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof CustomerPaginatedResponse && equalTo((CustomerPaginatedResponse) other);
  }

  private boolean equalTo(CustomerPaginatedResponse other) {
  ...
  public String toString() {
    return "CustomerPaginatedResponse{" + "count: " + count + ", next: " + next + ", previous: " + previous + ", results: " + results + "}";
  }
  ...
  public static final class Builder {
    ...
    private Optional<List<CustomerPaginatedResponseResultsItem>> results = Optional.empty();

    private Builder() {
    }

    public Builder from(CustomerPaginatedResponse other) {
    ...
    public Builder results(Optional<List<CustomerPaginatedResponseResultsItem>> results) {
      this.results = results;
      return this;
    }

    public Builder results(List<CustomerPaginatedResponseResultsItem> results) {
      this.results = Optional.of(results);
      return this;
    }

    public CustomerPaginatedResponse build() {
      return new CustomerPaginatedResponse(count, next, previous, results);
    }
  }
}

...
@JsonDeserialize(
    builder = PaymentIntentPaginatedResponse.Builder.class
)
public final class PaymentIntentPaginatedResponse {
  ...
  private final Optional<List<PaymentIntentPse>> results;

  private int _cachedHashCode;

  PaymentIntentPaginatedResponse(Optional<Integer> count, Optional<String> next,
      Optional<String> previous, Optional<List<PaymentIntentPse>> results) {
    this.count = count;
    this.next = next;
  ...
  /**
   * @return Array of payment intent objects.
   */
  @JsonProperty("results")
  public Optional<List<PaymentIntentPse>> getResults() {
    return results;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PaymentIntentPaginatedResponse && equalTo((PaymentIntentPaginatedResponse) other);
  }

  private boolean equalTo(PaymentIntentPaginatedResponse other) {
  ...
  public String toString() {
    return "PaymentIntentPaginatedResponse{" + "count: " + count + ", next: " + next + ", previous: " + previous + ", results: " + results + "}";
  }
  ...
  public static final class Builder {
    ...
    private Optional<List<PaymentIntentPse>> results = Optional.empty();

    private Builder() {
    }

    public Builder from(PaymentIntentPaginatedResponse other) {
    ...
    public Builder results(Optional<List<PaymentIntentPse>> results) {
      this.results = results;
      return this;
    }

    public Builder results(List<PaymentIntentPse> results) {
      this.results = Optional.of(results);
      return this;
    }

    public PaymentIntentPaginatedResponse build() {
      return new PaymentIntentPaginatedResponse(count, next, previous, results);
    }
  }
}

...
@JsonDeserialize(
    builder = PaymentIntentsPaymentMethodDetailsBodyPse.Builder.class
)
public final class PaymentIntentsPaymentMethodDetailsBodyPse {
  ...
  PaymentIntentsPaymentMethodDetailsBodyPse(String beneficiaryBankAccount,
  ...
  /**
   * @return This parameter determines the payment flow of the payment intent. By default, this is set to <code>true</code> and the payment intent created is processed using Belvo's payment flow and Belvo-integrated institutions. When set to <code>false</code>, the payment intent process uses institutions not integrated into Belvo's flow.
   */
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PaymentIntentsPaymentMethodDetailsBodyPse && equalTo((PaymentIntentsPaymentMethodDetailsBodyPse) other);
  }

  private boolean equalTo(PaymentIntentsPaymentMethodDetailsBodyPse other) {
  ...
  public String toString() {
    return "PaymentIntentsPaymentMethodDetailsBodyPse{" + "beneficiaryBankAccount: " + beneficiaryBankAccount + ", callbackUrl: " + callbackUrl + ", belvoFlow: " + belvoFlow + "}";
  }
  ...
  public interface BeneficiaryBankAccountStage {
    ...
    Builder from(PaymentIntentsPaymentMethodDetailsBodyPse other);
  }
  ...
  public interface _FinalStage {
    PaymentIntentsPaymentMethodDetailsBodyPse build();
  ...
  public static final class Builder implements BeneficiaryBankAccountStage, BelvoFlowStage, _FinalStage {
    ...
    @Override
    public Builder from(PaymentIntentsPaymentMethodDetailsBodyPse other) {
    ...
    /**
     * <p>This parameter determines the payment flow of the payment intent. By default, this is set to <code>true</code> and the payment intent created is processed using Belvo's payment flow and Belvo-integrated institutions. When set to <code>false</code>, the payment intent process uses institutions not integrated into Belvo's flow.</p>
     * @return Reference to {@code this} so that method calls can be chained together.
     */
    @Override
    ...
    @Override
    public PaymentIntentsPaymentMethodDetailsBodyPse build() {
      return new PaymentIntentsPaymentMethodDetailsBodyPse(beneficiaryBankAccount, callbackUrl, belvoFlow);
    }
  }
}

...
@JsonDeserialize(
    builder = TaxStatusAddressDian.Builder.class
)
public final class TaxStatusAddressDian {
  ...
  private final Optional<List<TaxStatusAddressBetweenStreetDian>> betweenStreet;

  private int _cachedHashCode;

  TaxStatusAddressDian(Optional<String> postalCode, Optional<String> streetType,
      ...
      Optional<String> state, Optional<List<TaxStatusAddressBetweenStreetDian>> betweenStreet) {
  ...
  public Optional<List<TaxStatusAddressBetweenStreetDian>> getBetweenStreet() {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof TaxStatusAddressDian && equalTo((TaxStatusAddressDian) other);
  }

  private boolean equalTo(TaxStatusAddressDian other) {
  ...
  public String toString() {
    return "TaxStatusAddressDian{" + "postalCode: " + postalCode + ", streetType: " + streetType + ", street: " + street + ", exteriorNumber: " + exteriorNumber + ", interiorNumber: " + interiorNumber + ", suburb: " + suburb + ", locality: " + locality + ", municipality: " + municipality + ", state: " + state + ", betweenStreet: " + betweenStreet + "}";
  }
  ...
  public static final class Builder {
    ...
    private Optional<List<TaxStatusAddressBetweenStreetDian>> betweenStreet = Optional.empty();

    private Builder() {
    }

    public Builder from(TaxStatusAddressDian other) {
    ...
    public Builder betweenStreet(Optional<List<TaxStatusAddressBetweenStreetDian>> betweenStreet) {
      this.betweenStreet = betweenStreet;
      return this;
    }

    public Builder betweenStreet(List<TaxStatusAddressBetweenStreetDian> betweenStreet) {
      this.betweenStreet = Optional.of(betweenStreet);
      return this;
    }

    public TaxStatusAddressDian build() {
      return new TaxStatusAddressDian(postalCode, streetType, street, exteriorNumber, interiorNumber, suburb, locality, municipality, state, betweenStreet);
    }
  }
}

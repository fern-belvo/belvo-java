...
@JsonDeserialize(
    builder = TransactionsRequest.Builder.class
)
public final class TransactionsRequest {
  ...
  TransactionsRequest(String link, Optional<String> account, String dateFrom, String dateTo,
      Optional<String> token, Optional<Boolean> saveData) {
    this.link = link;
  ...
  /**
   * @return If provided, we return transactions only from this account.
   */
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof TransactionsRequest && equalTo((TransactionsRequest) other);
  }

  private boolean equalTo(TransactionsRequest other) {
    return link.equals(other.link) && account.equals(other.account) && dateFrom.equals(other.dateFrom) && dateTo.equals(other.dateTo) && token.equals(other.token) && saveData.equals(other.saveData);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.link, this.account, this.dateFrom, this.dateTo, this.token, this.saveData);
    }
  ...
  public String toString() {
    return "TransactionsRequest{" + "link: " + link + ", account: " + account + ", dateFrom: " + dateFrom + ", dateTo: " + dateTo + ", token: " + token + ", saveData: " + saveData + "}";
  }
  ...
  public interface LinkStage {
    ...
    Builder from(TransactionsRequest other);
  }
  ...
  public static final class Builder implements LinkStage, DateFromStage, DateToStage, _FinalStage {
    ...
    @Override
    public Builder from(TransactionsRequest other) {
      link(other.getLink());
    ...
    /**
     * <p>If provided, we return transactions only from this account.</p>
     * @return Reference to {@code this} so that method calls can be chained together.
     */
    @Override
    ...
    public TransactionsRequest build() {
      return new TransactionsRequest(link, account, dateFrom, dateTo, token, saveData);
    }
  }
}

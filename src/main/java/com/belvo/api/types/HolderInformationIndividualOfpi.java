...
@JsonDeserialize(
    builder = HolderInformationIndividualOfpi.Builder.class
)
public final class HolderInformationIndividualOfpi {
  ...
  HolderInformationIndividualOfpi(String firstName, String lastName,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof HolderInformationIndividualOfpi && equalTo((HolderInformationIndividualOfpi) other);
  }

  private boolean equalTo(HolderInformationIndividualOfpi other) {
  ...
  public String toString() {
    return "HolderInformationIndividualOfpi{" + "firstName: " + firstName + ", lastName: " + lastName + ", identifierType: " + identifierType + ", identifier: " + identifier + "}";
  }
  ...
  public interface FirstNameStage {
    ...
    Builder from(HolderInformationIndividualOfpi other);
  }
  ...
  public interface _FinalStage {
    HolderInformationIndividualOfpi build();
  }
  ...
  public static final class Builder implements FirstNameStage, LastNameStage, IdentifierTypeStage, IdentifierStage, _FinalStage {
    ...
    @Override
    public Builder from(HolderInformationIndividualOfpi other) {
    ...
    @Override
    public HolderInformationIndividualOfpi build() {
      return new HolderInformationIndividualOfpi(firstName, lastName, identifierType, identifier);
    }
  }
}

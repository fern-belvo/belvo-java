...
@JsonDeserialize(
    builder = PaymentIntentPaymentMethodDetailsBodyIndividualOfpi.Builder.class
)
public final class PaymentIntentPaymentMethodDetailsBodyIndividualOfpi {
  ...
  PaymentIntentPaymentMethodDetailsBodyIndividualOfpi(String beneficiaryBankAccount,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PaymentIntentPaymentMethodDetailsBodyIndividualOfpi && equalTo((PaymentIntentPaymentMethodDetailsBodyIndividualOfpi) other);
  }

  private boolean equalTo(PaymentIntentPaymentMethodDetailsBodyIndividualOfpi other) {
  ...
  public String toString() {
    return "PaymentIntentPaymentMethodDetailsBodyIndividualOfpi{" + "beneficiaryBankAccount: " + beneficiaryBankAccount + ", payerInstitution: " + payerInstitution + ", callbackUrl: " + callbackUrl + ", cpf: " + cpf + "}";
  }
  ...
  public interface BeneficiaryBankAccountStage {
    ...
    Builder from(PaymentIntentPaymentMethodDetailsBodyIndividualOfpi other);
  }
  ...
  public interface _FinalStage {
    PaymentIntentPaymentMethodDetailsBodyIndividualOfpi build();
  ...
  public static final class Builder implements BeneficiaryBankAccountStage, PayerInstitutionStage, CallbackUrlStage, _FinalStage {
    ...
    @Override
    public Builder from(PaymentIntentPaymentMethodDetailsBodyIndividualOfpi other) {
    ...
    @Override
    public PaymentIntentPaymentMethodDetailsBodyIndividualOfpi build() {
      return new PaymentIntentPaymentMethodDetailsBodyIndividualOfpi(beneficiaryBankAccount, payerInstitution, callbackUrl, cpf);
    }
  }
}

...
@JsonDeserialize(
    builder = InvoiceDetailDian.Builder.class
)
public final class InvoiceDetailDian {
  ...
  InvoiceDetailDian(Optional<String> description, Optional<String> productIdentification,
      Optional<Double> quantity, Optional<String> unitCode, Optional<String> unitDescription,
  ...
  /**
   * @return The price of one singular item.
   */
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof InvoiceDetailDian && equalTo((InvoiceDetailDian) other);
  }

  private boolean equalTo(InvoiceDetailDian other) {
    return description.equals(other.description) && productIdentification.equals(other.productIdentification) && quantity.equals(other.quantity) && unitCode.equals(other.unitCode) && unitDescription.equals(other.unitDescription) && unitAmount.equals(other.unitAmount) && taxType.equals(other.taxType) && preTaxAmount.equals(other.preTaxAmount) && taxPercentage.equals(other.taxPercentage) && taxAmount.equals(other.taxAmount) && totalAmount.equals(other.totalAmount) && collectedAt.equals(other.collectedAt);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.description, this.productIdentification, this.quantity, this.unitCode, this.unitDescription, this.unitAmount, this.taxType, this.preTaxAmount, this.taxPercentage, this.taxAmount, this.totalAmount, this.collectedAt);
    }
  ...
  public String toString() {
    return "InvoiceDetailDian{" + "description: " + description + ", productIdentification: " + productIdentification + ", quantity: " + quantity + ", unitCode: " + unitCode + ", unitDescription: " + unitDescription + ", unitAmount: " + unitAmount + ", taxType: " + taxType + ", preTaxAmount: " + preTaxAmount + ", taxPercentage: " + taxPercentage + ", taxAmount: " + taxAmount + ", totalAmount: " + totalAmount + ", collectedAt: " + collectedAt + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(InvoiceDetailDian other) {
    ...
    public InvoiceDetailDian build() {
      return new InvoiceDetailDian(description, productIdentification, quantity, unitCode, unitDescription, unitAmount, taxType, preTaxAmount, taxPercentage, taxAmount, totalAmount, collectedAt);
    }
  }
}

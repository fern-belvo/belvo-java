...
@JsonDeserialize(
    builder = DisplayPaymentFailed.Builder.class
)
public final class DisplayPaymentFailed {
  private final Optional<PaymentInstitution> payerInstitution;

  private int _cachedHashCode;

  DisplayPaymentFailed(Optional<PaymentInstitution> payerInstitution) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DisplayPaymentFailed && equalTo((DisplayPaymentFailed) other);
  }

  private boolean equalTo(DisplayPaymentFailed other) {
  ...
  public String toString() {
    return "DisplayPaymentFailed{" + "payerInstitution: " + payerInstitution + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(DisplayPaymentFailed other) {
    ...
    public DisplayPaymentFailed build() {
      return new DisplayPaymentFailed(payerInstitution);
    }
  }
}

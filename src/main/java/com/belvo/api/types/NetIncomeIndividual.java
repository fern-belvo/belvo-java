...
@JsonDeserialize(
    builder = NetIncomeIndividual.Builder.class
)
public final class NetIncomeIndividual {
  ...
  NetIncomeIndividual(double earnedIncome, double feeBasedIncome, double capitalIncome,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof NetIncomeIndividual && equalTo((NetIncomeIndividual) other);
  }

  private boolean equalTo(NetIncomeIndividual other) {
  ...
  public String toString() {
    return "NetIncomeIndividual{" + "earnedIncome: " + earnedIncome + ", feeBasedIncome: " + feeBasedIncome + ", capitalIncome: " + capitalIncome + ", nonLaborIncome: " + nonLaborIncome + "}";
  }
  ...
  public interface EarnedIncomeStage {
    ...
    Builder from(NetIncomeIndividual other);
  }
  ...
  public static final class Builder implements EarnedIncomeStage, FeeBasedIncomeStage, CapitalIncomeStage, NonLaborIncomeStage, _FinalStage {
    ...
    @Override
    public Builder from(NetIncomeIndividual other) {
    ...
    @Override
    public NetIncomeIndividual build() {
      return new NetIncomeIndividual(earnedIncome, feeBasedIncome, capitalIncome, nonLaborIncome);
    }
  }
}

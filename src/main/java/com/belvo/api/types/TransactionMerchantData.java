...
@JsonDeserialize(
    builder = TransactionMerchantData.Builder.class
)
public final class TransactionMerchantData {
  ...
  TransactionMerchantData(Optional<String> logo, Optional<String> website,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof TransactionMerchantData && equalTo((TransactionMerchantData) other);
  }

  private boolean equalTo(TransactionMerchantData other) {
  ...
  public String toString() {
    return "TransactionMerchantData{" + "logo: " + logo + ", website: " + website + ", merchantName: " + merchantName + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(TransactionMerchantData other) {
      logo(other.getLogo());
    ...
    public TransactionMerchantData build() {
      return new TransactionMerchantData(logo, website, merchantName);
    }
  }
}

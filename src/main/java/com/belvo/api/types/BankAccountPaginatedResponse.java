...
@JsonDeserialize(
    builder = BankAccountPaginatedResponse.Builder.class
)
public final class BankAccountPaginatedResponse {
  ...
  private final Optional<List<BankAccountPaginatedResponseResultsItem>> results;

  private int _cachedHashCode;

  BankAccountPaginatedResponse(Optional<Integer> count, Optional<String> next,
      Optional<String> previous, Optional<List<BankAccountPaginatedResponseResultsItem>> results) {
    this.count = count;
    this.next = next;
  ...
  public Optional<List<BankAccountPaginatedResponseResultsItem>> getResults() {
    return results;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof BankAccountPaginatedResponse && equalTo((BankAccountPaginatedResponse) other);
  }

  private boolean equalTo(BankAccountPaginatedResponse other) {
  ...
  public String toString() {
    return "BankAccountPaginatedResponse{" + "count: " + count + ", next: " + next + ", previous: " + previous + ", results: " + results + "}";
  }
  ...
  public static final class Builder {
    ...
    private Optional<List<BankAccountPaginatedResponseResultsItem>> results = Optional.empty();

    private Builder() {
    }

    public Builder from(BankAccountPaginatedResponse other) {
    ...
    public Builder results(Optional<List<BankAccountPaginatedResponseResultsItem>> results) {
      this.results = results;
      return this;
    }

    public Builder results(List<BankAccountPaginatedResponseResultsItem> results) {
      this.results = Optional.of(results);
      return this;
    }

    public BankAccountPaginatedResponse build() {
      return new BankAccountPaginatedResponse(count, next, previous, results);
    }
  }
}

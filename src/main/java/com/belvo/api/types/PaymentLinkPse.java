...
@JsonDeserialize(
    builder = PaymentLinkPse.Builder.class
)
public final class PaymentLinkPse {
  ...
  private final Optional<PaymentIntentPse> paymentIntent;
  ...
  PaymentLinkPse(String id, String createdAt, String createdBy, String paymentUrl,
      Optional<String> accessToken, PaymentLinkCallbackUrlsResponse callbackUrls,
      Optional<PaymentIntentPse> paymentIntent, Optional<String> updatedAt,
  ...
  public Optional<PaymentIntentPse> getPaymentIntent() {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PaymentLinkPse && equalTo((PaymentLinkPse) other);
  }

  private boolean equalTo(PaymentLinkPse other) {
  ...
  public String toString() {
    return "PaymentLinkPse{" + "id: " + id + ", createdAt: " + createdAt + ", createdBy: " + createdBy + ", paymentUrl: " + paymentUrl + ", accessToken: " + accessToken + ", callbackUrls: " + callbackUrls + ", paymentIntent: " + paymentIntent + ", updatedAt: " + updatedAt + ", status: " + status + ", expiresIn: " + expiresIn + ", expiresAt: " + expiresAt + "}";
  }
  ...
  public interface IdStage {
    ...
    Builder from(PaymentLinkPse other);
  }
  ...
  public interface _FinalStage {
    PaymentLinkPse build();

    _FinalStage accessToken(Optional<String> accessToken);

    _FinalStage accessToken(String accessToken);

    _FinalStage paymentIntent(Optional<PaymentIntentPse> paymentIntent);

    _FinalStage paymentIntent(PaymentIntentPse paymentIntent);
  ...
  public static final class Builder implements IdStage, CreatedAtStage, CreatedByStage, PaymentUrlStage, CallbackUrlsStage, StatusStage, ExpiresInStage, ExpiresAtStage, _FinalStage {
    ...
    private Optional<PaymentIntentPse> paymentIntent = Optional.empty();
    ...
    @Override
    public Builder from(PaymentLinkPse other) {
      id(other.getId());
    ...
    @Override
    public _FinalStage paymentIntent(PaymentIntentPse paymentIntent) {
    ...
    public _FinalStage paymentIntent(Optional<PaymentIntentPse> paymentIntent) {
      this.paymentIntent = paymentIntent;
      return this;
    }
    ...
    @Override
    public PaymentLinkPse build() {
      return new PaymentLinkPse(id, createdAt, createdBy, paymentUrl, accessToken, callbackUrls, paymentIntent, updatedAt, status, expiresIn, expiresAt);
    }
  }
}

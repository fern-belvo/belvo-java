...
@JsonDeserialize(
    builder = PaymentIntentOfpi.Builder.class
)
public final class PaymentIntentOfpi {
  ...
  private final List<String> allowedPaymentMethodTypes;
  ...
  private final PaymentIntentOfpiNextStep nextStep;

  private final LastErrorPaymentError lastError;

  private final PaymentIntentOfpiPaymentMethodDetails paymentMethodDetails;

  private final PaymentMethodInformationOfpi paymentMethodInformation;
  ...
  PaymentIntentOfpi(String id, String createdAt, String createdBy, String customer,
      List<String> allowedPaymentMethodTypes, String amount, EnumPaymentsCurrency currency,
      String description, Optional<String> failureCode, Optional<String> failureMessage,
      Optional<Map<String, Object>> metadata, PaymentIntentOfpiNextStep nextStep,
      LastErrorPaymentError lastError, PaymentIntentOfpiPaymentMethodDetails paymentMethodDetails,
      PaymentMethodInformationOfpi paymentMethodInformation, Optional<List<Charge>> charges,
  ...
  /**
   * @return A list of payment method types allowed in this payment intent. For OFPI, the value will be <code>open_finance</code>.
   */
  ...
  public PaymentIntentOfpiNextStep getNextStep() {
    return nextStep;
  }

  @JsonProperty("last_error")
  public LastErrorPaymentError getLastError() {
    return lastError;
  }

  @JsonProperty("payment_method_details")
  public PaymentIntentOfpiPaymentMethodDetails getPaymentMethodDetails() {
    return paymentMethodDetails;
  }

  @JsonProperty("payment_method_information")
  public PaymentMethodInformationOfpi getPaymentMethodInformation() {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PaymentIntentOfpi && equalTo((PaymentIntentOfpi) other);
  }

  private boolean equalTo(PaymentIntentOfpi other) {
  ...
  public interface IdStage {
    ...
    Builder from(PaymentIntentOfpi other);
  }
  ...
  public interface NextStepStage {
    LastErrorStage nextStep(PaymentIntentOfpiNextStep nextStep);
  }

  public interface LastErrorStage {
    PaymentMethodDetailsStage lastError(LastErrorPaymentError lastError);
  }

  public interface PaymentMethodDetailsStage {
    PaymentMethodInformationStage paymentMethodDetails(
        PaymentIntentOfpiPaymentMethodDetails paymentMethodDetails);
  }

  public interface PaymentMethodInformationStage {
    ProviderStage paymentMethodInformation(PaymentMethodInformationOfpi paymentMethodInformation);
  }
  ...
  public interface _FinalStage {
    PaymentIntentOfpi build();

    _FinalStage allowedPaymentMethodTypes(List<String> allowedPaymentMethodTypes);

    _FinalStage addAllowedPaymentMethodTypes(String allowedPaymentMethodTypes);

    _FinalStage addAllAllowedPaymentMethodTypes(List<String> allowedPaymentMethodTypes);
  ...
  public static final class Builder implements IdStage, CreatedAtStage, CreatedByStage, CustomerStage, AmountStage, CurrencyStage, DescriptionStage, NextStepStage, LastErrorStage, PaymentMethodDetailsStage, PaymentMethodInformationStage, ProviderStage, SelectedPaymentMethodTypeStage, StatusStage, _FinalStage {
    ...
    private PaymentIntentOfpiNextStep nextStep;

    private LastErrorPaymentError lastError;

    private PaymentIntentOfpiPaymentMethodDetails paymentMethodDetails;

    private PaymentMethodInformationOfpi paymentMethodInformation;
    ...
    private List<String> allowedPaymentMethodTypes = new ArrayList<>();

    private Builder() {
    }

    @Override
    public Builder from(PaymentIntentOfpi other) {
      id(other.getId());
    ...
    public LastErrorStage nextStep(PaymentIntentOfpiNextStep nextStep) {
      this.nextStep = nextStep;
      return this;
    }
    ...
    public PaymentMethodDetailsStage lastError(LastErrorPaymentError lastError) {
      this.lastError = lastError;
      return this;
    }
    ...
    public ProviderStage paymentMethodInformation(
        PaymentMethodInformationOfpi paymentMethodInformation) {
      this.paymentMethodInformation = paymentMethodInformation;
      return this;
    }
    ...
    /**
     * <p>A list of payment method types allowed in this payment intent. For OFPI, the value will be <code>open_finance</code>.</p>
     * @return Reference to {@code this} so that method calls can be chained together.
     */
    @Override
    public _FinalStage addAllAllowedPaymentMethodTypes(List<String> allowedPaymentMethodTypes) {
     ...
     */
    @Override
    public _FinalStage addAllowedPaymentMethodTypes(String allowedPaymentMethodTypes) {
    ...
    public _FinalStage allowedPaymentMethodTypes(List<String> allowedPaymentMethodTypes) {
    ...
    @Override
    public PaymentIntentOfpi build() {
      return new PaymentIntentOfpi(id, createdAt, createdBy, customer, allowedPaymentMethodTypes, amount, currency, description, failureCode, failureMessage, metadata, nextStep, lastError, paymentMethodDetails, paymentMethodInformation, charges, provider, selectedPaymentMethodType, status, updatedAt);
    }
  }
}

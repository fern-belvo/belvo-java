...
@JsonDeserialize(
    builder = AccountsPaginatedResponse.Builder.class
)
public final class AccountsPaginatedResponse {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof AccountsPaginatedResponse && equalTo((AccountsPaginatedResponse) other);
  }

  private boolean equalTo(AccountsPaginatedResponse other) {
  ...
  public String toString() {
    return "AccountsPaginatedResponse{" + "count: " + count + ", next: " + next + ", previous: " + previous + ", results: " + results + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(AccountsPaginatedResponse other) {
    ...
    public AccountsPaginatedResponse build() {
      return new AccountsPaginatedResponse(count, next, previous, results);
    }
  }
}

...
public final class UnauthorizedErrorBody {
  ...
  UnauthorizedErrorBody(Optional<String> code, Optional<String> message,
  ...
  /**
   * @return A unique error code (<code>authentication_failed</code>) that allows you to classify and handle the error programmatically.
   * <p>ℹ️ Check our DevPortal for more information on how to handle &lt;a href=&quot;https://developers.belvo.com/docs/belvo-api-errors#401-authentication_failed&quot; target=&quot;_blank&quot;&gt;401 authentication_failed errors&lt;/a&gt;.</p>
   */
  @JsonProperty("code")
   ...
   * <p>For <code>authentication_failed</code> errors, the description is:</p>
   * <ul>
   * <li><code>Invalid Secret Keys</code>.</li>
   * </ul>
   */
  ...
  public String toString() {
    return "UnauthorizedErrorBody{" + "code: " + code + ", message: " + message + ", requestId: " + requestId + "}";
  }
  ...
  public static final class Builder {
    ...
    public UnauthorizedErrorBody build() {
      return new UnauthorizedErrorBody(code, message, requestId);
    }
  }
}

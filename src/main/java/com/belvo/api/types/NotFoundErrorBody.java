...
public final class NotFoundErrorBody {
  ...
  NotFoundErrorBody(Optional<String> code, Optional<String> message, Optional<String> requestId) {
    this.code = code;
  ...
  /**
   * @return A unique error code (<code>not_found</code>) that allows you to classify and handle the error programmatically.
   * <p>ℹ️ Check our DevPortal for more information on how to handle &lt;a href=&quot;https://developers.belvo.com/docs/belvo-api-errors#404-not_found&quot; target=&quot;_blank&quot;&gt;404 not_found errors&lt;/a&gt;.</p>
   */
  @JsonProperty("code")
   ...
   * <p>For <code>not_found</code> errors, the description is:</p>
   * <ul>
  ...
  public String toString() {
    return "NotFoundErrorBody{" + "code: " + code + ", message: " + message + ", requestId: " + requestId + "}";
  }
  ...
  public static final class Builder {
    ...
    public NotFoundErrorBody build() {
      return new NotFoundErrorBody(code, message, requestId);
    }
  }
}

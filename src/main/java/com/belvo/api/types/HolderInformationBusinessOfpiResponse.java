...
@JsonDeserialize(
    builder = HolderInformationBusinessOfpiResponse.Builder.class
)
public final class HolderInformationBusinessOfpiResponse {
  ...
  HolderInformationBusinessOfpiResponse(String name, EnumCustomerIdentifierTypeOfpi identifierType,
      String identifier) {
    this.name = name;
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof HolderInformationBusinessOfpiResponse && equalTo((HolderInformationBusinessOfpiResponse) other);
  }

  private boolean equalTo(HolderInformationBusinessOfpiResponse other) {
  ...
  public String toString() {
    return "HolderInformationBusinessOfpiResponse{" + "name: " + name + ", identifierType: " + identifierType + ", identifier: " + identifier + "}";
  }
  ...
  public interface NameStage {
    ...
    Builder from(HolderInformationBusinessOfpiResponse other);
  }
  ...
  public interface _FinalStage {
    HolderInformationBusinessOfpiResponse build();
  }
  ...
  public static final class Builder implements NameStage, IdentifierTypeStage, IdentifierStage, _FinalStage {
    ...
    @Override
    public Builder from(HolderInformationBusinessOfpiResponse other) {
      name(other.getName());
    ...
    @Override
    public HolderInformationBusinessOfpiResponse build() {
      return new HolderInformationBusinessOfpiResponse(name, identifierType, identifier);
    }
  }
}

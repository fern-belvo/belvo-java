...
@JsonDeserialize(
    builder = NonTaxableIncomeIndividual.Builder.class
)
public final class NonTaxableIncomeIndividual {
  ...
  NonTaxableIncomeIndividual(double earnedIncome, double feeBasedIncome, double capitalIncome,
  ...
  /**
   * @return Income received from emitted invoices (for example, income independent contractors or freelancers receive).
   */
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof NonTaxableIncomeIndividual && equalTo((NonTaxableIncomeIndividual) other);
  }

  private boolean equalTo(NonTaxableIncomeIndividual other) {
  ...
  public String toString() {
    return "NonTaxableIncomeIndividual{" + "earnedIncome: " + earnedIncome + ", feeBasedIncome: " + feeBasedIncome + ", capitalIncome: " + capitalIncome + ", nonLaborIncome: " + nonLaborIncome + "}";
  }
  ...
  public interface EarnedIncomeStage {
    ...
    Builder from(NonTaxableIncomeIndividual other);
  }
  ...
  public interface _FinalStage {
    NonTaxableIncomeIndividual build();
  }
  ...
  public static final class Builder implements EarnedIncomeStage, FeeBasedIncomeStage, CapitalIncomeStage, NonLaborIncomeStage, _FinalStage {
    ...
    @Override
    public Builder from(NonTaxableIncomeIndividual other) {
    ...
    /**
     * <p>Income received from emitted invoices (for example, income independent contractors or freelancers receive).</p>
     * @return Reference to {@code this} so that method calls can be chained together.
     */
    @Override
    ...
    @Override
    public NonTaxableIncomeIndividual build() {
      return new NonTaxableIncomeIndividual(earnedIncome, feeBasedIncome, capitalIncome, nonLaborIncome);
    }
  }
}

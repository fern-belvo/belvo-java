...
@JsonDeserialize(
    builder = NeedsRedirectContent.Builder.class
)
public final class NeedsRedirectContent {
  private final Optional<PaymentInstitution> payerInstitution;

  private int _cachedHashCode;

  NeedsRedirectContent(Optional<PaymentInstitution> payerInstitution) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof NeedsRedirectContent && equalTo((NeedsRedirectContent) other);
  }

  private boolean equalTo(NeedsRedirectContent other) {
  ...
  public String toString() {
    return "NeedsRedirectContent{" + "payerInstitution: " + payerInstitution + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(NeedsRedirectContent other) {
    ...
    public NeedsRedirectContent build() {
      return new NeedsRedirectContent(payerInstitution);
    }
  }
}

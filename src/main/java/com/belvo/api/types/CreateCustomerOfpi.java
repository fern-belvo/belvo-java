...
@JsonDeserialize(
    builder = CreateCustomerOfpi.Builder.class
)
public final class CreateCustomerOfpi {
  ...
  CreateCustomerOfpi(EnumCustomerType customerType, String name, EnumPaymentsCountry country,
      String email, String identifier, EnumCustomerIdentifierTypeOfpi identifierType,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof CreateCustomerOfpi && equalTo((CreateCustomerOfpi) other);
  }

  private boolean equalTo(CreateCustomerOfpi other) {
  ...
  public String toString() {
    return "CreateCustomerOfpi{" + "customerType: " + customerType + ", name: " + name + ", country: " + country + ", email: " + email + ", identifier: " + identifier + ", identifierType: " + identifierType + ", address: " + address + ", phone: " + phone + "}";
  }
  ...
  public interface CustomerTypeStage {
    ...
    Builder from(CreateCustomerOfpi other);
  }
  ...
  public interface IdentifierTypeStage {
    _FinalStage identifierType(EnumCustomerIdentifierTypeOfpi identifierType);
  }

  public interface _FinalStage {
    CreateCustomerOfpi build();
  ...
  public static final class Builder implements CustomerTypeStage, NameStage, CountryStage, EmailStage, IdentifierStage, IdentifierTypeStage, _FinalStage {
    ...
    @Override
    public Builder from(CreateCustomerOfpi other) {
    ...
    public _FinalStage identifierType(EnumCustomerIdentifierTypeOfpi identifierType) {
      this.identifierType = identifierType;
      return this;
    }
    ...
    @Override
    public CreateCustomerOfpi build() {
      return new CreateCustomerOfpi(customerType, name, country, email, identifier, identifierType, address, phone);
    }
  }
}

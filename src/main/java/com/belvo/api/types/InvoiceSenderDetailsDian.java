...
@JsonDeserialize(
    builder = InvoiceSenderDetailsDian.Builder.class
)
public final class InvoiceSenderDetailsDian {
  ...
  InvoiceSenderDetailsDian(Optional<String> collectedAt, Optional<String> taxPayerType,
  ...
  /**
   * @return Indicates if the sender is a business or an individual. Can be either:
   * <ul>
  ...
  /**
   * @return The sender's regimen type.
  ...
  /**
   * @return The sender's fiscal responsibilities.
  ...
  /**
   * @return The country where the sender pays their taxes.
   */
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof InvoiceSenderDetailsDian && equalTo((InvoiceSenderDetailsDian) other);
  }

  private boolean equalTo(InvoiceSenderDetailsDian other) {
  ...
  public String toString() {
    return "InvoiceSenderDetailsDian{" + "collectedAt: " + collectedAt + ", taxPayerType: " + taxPayerType + ", regimen: " + regimen + ", taxScheme: " + taxScheme + ", country: " + country + ", address: " + address + ", phoneNumber: " + phoneNumber + ", email: " + email + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(InvoiceSenderDetailsDian other) {
    ...
    public InvoiceSenderDetailsDian build() {
      return new InvoiceSenderDetailsDian(collectedAt, taxPayerType, regimen, taxScheme, country, address, phoneNumber, email);
    }
  }
}

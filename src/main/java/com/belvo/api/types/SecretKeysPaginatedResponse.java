...
@JsonDeserialize(
    builder = SecretKeysPaginatedResponse.Builder.class
)
public final class SecretKeysPaginatedResponse {
  ...
  private final Optional<List<SecretKeys>> results;

  private int _cachedHashCode;

  SecretKeysPaginatedResponse(Optional<Integer> count, Optional<String> next,
      Optional<String> previous, Optional<List<SecretKeys>> results) {
    this.count = count;
    this.next = next;
  ...
  /**
   * @return Array of secret keys objects.
   */
  @JsonProperty("results")
  public Optional<List<SecretKeys>> getResults() {
    return results;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof SecretKeysPaginatedResponse && equalTo((SecretKeysPaginatedResponse) other);
  }

  private boolean equalTo(SecretKeysPaginatedResponse other) {
  ...
  public String toString() {
    return "SecretKeysPaginatedResponse{" + "count: " + count + ", next: " + next + ", previous: " + previous + ", results: " + results + "}";
  }
  ...
  public static final class Builder {
    ...
    private Optional<List<SecretKeys>> results = Optional.empty();

    private Builder() {
    }

    public Builder from(SecretKeysPaginatedResponse other) {
    ...
    public Builder results(Optional<List<SecretKeys>> results) {
      this.results = results;
      return this;
    }

    public Builder results(List<SecretKeys> results) {
      this.results = Optional.of(results);
      return this;
    }

    public SecretKeysPaginatedResponse build() {
      return new SecretKeysPaginatedResponse(count, next, previous, results);
    }
  }
}

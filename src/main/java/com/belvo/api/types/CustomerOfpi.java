...
@JsonDeserialize(
    builder = CustomerOfpi.Builder.class
)
public final class CustomerOfpi {
  ...
  CustomerOfpi(String id, String createdAt, String createdBy, EnumCustomerType customerType,
      String name, EnumPaymentsCountry country, String email, String identifier,
      EnumCustomerIdentifierTypeOfpi identifierType, Optional<String> address,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof CustomerOfpi && equalTo((CustomerOfpi) other);
  }

  private boolean equalTo(CustomerOfpi other) {
  ...
  public String toString() {
    return "CustomerOfpi{" + "id: " + id + ", createdAt: " + createdAt + ", createdBy: " + createdBy + ", customerType: " + customerType + ", name: " + name + ", country: " + country + ", email: " + email + ", identifier: " + identifier + ", identifierType: " + identifierType + ", address: " + address + ", phone: " + phone + "}";
  }
  ...
  public interface IdStage {
    ...
    Builder from(CustomerOfpi other);
  }
  ...
  public static final class Builder implements IdStage, CreatedAtStage, CreatedByStage, CustomerTypeStage, NameStage, CountryStage, EmailStage, IdentifierStage, IdentifierTypeStage, _FinalStage {
    ...
    @Override
    public Builder from(CustomerOfpi other) {
      id(other.getId());
    ...
    @Override
    public CustomerOfpi build() {
      return new CustomerOfpi(id, createdAt, createdBy, customerType, name, country, email, identifier, identifierType, address, phone);
    }
  }
}

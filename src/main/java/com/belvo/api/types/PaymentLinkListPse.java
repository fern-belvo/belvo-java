...
@JsonDeserialize(
    builder = PaymentLinkListPse.Builder.class
)
public final class PaymentLinkListPse {
  ...
  PaymentLinkListPse(String id, String createdAt, String createdBy, String paymentUrl,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PaymentLinkListPse && equalTo((PaymentLinkListPse) other);
  }

  private boolean equalTo(PaymentLinkListPse other) {
  ...
  public String toString() {
    return "PaymentLinkListPse{" + "id: " + id + ", createdAt: " + createdAt + ", createdBy: " + createdBy + ", paymentUrl: " + paymentUrl + ", accessToken: " + accessToken + ", callbackUrls: " + callbackUrls + ", paymentIntent: " + paymentIntent + ", updatedAt: " + updatedAt + ", status: " + status + ", expiresIn: " + expiresIn + ", expiresAt: " + expiresAt + "}";
  }
  ...
  public interface IdStage {
    ...
    Builder from(PaymentLinkListPse other);
  }
  ...
  public static final class Builder implements IdStage, CreatedAtStage, CreatedByStage, PaymentUrlStage, CallbackUrlsStage, StatusStage, ExpiresInStage, ExpiresAtStage, _FinalStage {
    ...
    @Override
    public Builder from(PaymentLinkListPse other) {
      id(other.getId());
    ...
    @Override
    public PaymentLinkListPse build() {
      return new PaymentLinkListPse(id, createdAt, createdBy, paymentUrl, accessToken, callbackUrls, paymentIntent, updatedAt, status, expiresIn, expiresAt);
    }
  }
}

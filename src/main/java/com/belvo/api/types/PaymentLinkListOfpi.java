...
@JsonDeserialize(
    builder = PaymentLinkListOfpi.Builder.class
)
public final class PaymentLinkListOfpi {
  ...
  PaymentLinkListOfpi(String id, String createdAt, String createdBy, String paymentUrl,
      Optional<String> accessToken, PaymentLinkCallbackUrlsResponse callbackUrls,
      Optional<String> paymentIntent, Optional<String> updatedAt, EnumPaymentLinksStatus status,
  ...
  /**
   * @return Belvo's unique ID for the payment intent. You can retrieve the complete payment intent by using our <a href="https://developers.belvo.com/reference/detailcreatepaymentlink">Get details of a payment link</a> request.
   */
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PaymentLinkListOfpi && equalTo((PaymentLinkListOfpi) other);
  }

  private boolean equalTo(PaymentLinkListOfpi other) {
  ...
  public String toString() {
    return "PaymentLinkListOfpi{" + "id: " + id + ", createdAt: " + createdAt + ", createdBy: " + createdBy + ", paymentUrl: " + paymentUrl + ", accessToken: " + accessToken + ", callbackUrls: " + callbackUrls + ", paymentIntent: " + paymentIntent + ", updatedAt: " + updatedAt + ", status: " + status + ", expiresIn: " + expiresIn + ", expiresAt: " + expiresAt + "}";
  }
  ...
  public interface IdStage {
    ...
    Builder from(PaymentLinkListOfpi other);
  }
  ...
  public static final class Builder implements IdStage, CreatedAtStage, CreatedByStage, PaymentUrlStage, CallbackUrlsStage, StatusStage, ExpiresInStage, ExpiresAtStage, _FinalStage {
    ...
    @Override
    public Builder from(PaymentLinkListOfpi other) {
      id(other.getId());
    ...
    /**
     * <p>Belvo's unique ID for the payment intent. You can retrieve the complete payment intent by using our <a href="https://developers.belvo.com/reference/detailcreatepaymentlink">Get details of a payment link</a> request.</p>
     * @return Reference to {@code this} so that method calls can be chained together.
     */
    @Override
    ...
    @Override
    public PaymentLinkListOfpi build() {
      return new PaymentLinkListOfpi(id, createdAt, createdBy, paymentUrl, accessToken, callbackUrls, paymentIntent, updatedAt, status, expiresIn, expiresAt);
    }
  }
}

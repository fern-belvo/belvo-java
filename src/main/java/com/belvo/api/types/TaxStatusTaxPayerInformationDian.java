...
@JsonDeserialize(
    builder = TaxStatusTaxPayerInformationDian.Builder.class
)
public final class TaxStatusTaxPayerInformationDian {
  ...
  TaxStatusTaxPayerInformationDian(Optional<String> rfc, Optional<String> curp,
  ...
  /**
   * @return The tax payers's identification number (NIT).
   */
  @JsonProperty("rfc")
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof TaxStatusTaxPayerInformationDian && equalTo((TaxStatusTaxPayerInformationDian) other);
  }

  private boolean equalTo(TaxStatusTaxPayerInformationDian other) {
  ...
  public static final class Builder {
    ...
    public Builder from(TaxStatusTaxPayerInformationDian other) {
      rfc(other.getRfc());
      curp(other.getCurp());
      name(other.getName());
    ...
    public TaxStatusTaxPayerInformationDian build() {
      return new TaxStatusTaxPayerInformationDian(rfc, curp, name, firstLastName, secondLastName, startOperationsDate, statusPadron, lastStatusChangeDate, commercialName, socialName, email, phone);
    }
  }
}

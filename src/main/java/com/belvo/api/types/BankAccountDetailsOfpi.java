...
@JsonDeserialize(
    builder = BankAccountDetailsOfpi.Builder.class
)
public final class BankAccountDetailsOfpi {
  ...
  BankAccountDetailsOfpi(EnumPaymentsCountry country, EnumBankAccountPixAccountTypeOfpi accountType,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof BankAccountDetailsOfpi && equalTo((BankAccountDetailsOfpi) other);
  }

  private boolean equalTo(BankAccountDetailsOfpi other) {
  ...
  public String toString() {
    return "BankAccountDetailsOfpi{" + "country: " + country + ", accountType: " + accountType + ", agency: " + agency + ", number: " + number + "}";
  }
  ...
  public interface CountryStage {
    ...
    Builder from(BankAccountDetailsOfpi other);
  }
  ...
  public static final class Builder implements CountryStage, AccountTypeStage, AgencyStage, NumberStage, _FinalStage {
    ...
    @Override
    public Builder from(BankAccountDetailsOfpi other) {
    ...
    @Override
    public BankAccountDetailsOfpi build() {
      return new BankAccountDetailsOfpi(country, accountType, agency, number);
    }
  }
}

...
@JsonDeserialize(
    builder = DetailReceivableTransactionRequest.Builder.class
)
public final class DetailReceivableTransactionRequest {
  ...
  DetailReceivableTransactionRequest(Optional<String> omit, Optional<String> fields) {
    this.omit = omit;
    this.fields = fields;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DetailReceivableTransactionRequest && equalTo((DetailReceivableTransactionRequest) other);
  }

  private boolean equalTo(DetailReceivableTransactionRequest other) {
  ...
  public String toString() {
    return "DetailReceivableTransactionRequest{" + "omit: " + omit + ", fields: " + fields + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(DetailReceivableTransactionRequest other) {
      omit(other.getOmit());
    ...
    public DetailReceivableTransactionRequest build() {
      return new DetailReceivableTransactionRequest(omit, fields);
    }
  }
}

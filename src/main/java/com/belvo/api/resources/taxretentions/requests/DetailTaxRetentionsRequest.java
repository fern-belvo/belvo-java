...
@JsonDeserialize(
    builder = DetailTaxRetentionsRequest.Builder.class
)
public final class DetailTaxRetentionsRequest {
  ...
  DetailTaxRetentionsRequest(Optional<String> omit, Optional<String> fields) {
    this.omit = omit;
    this.fields = fields;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DetailTaxRetentionsRequest && equalTo((DetailTaxRetentionsRequest) other);
  }

  private boolean equalTo(DetailTaxRetentionsRequest other) {
  ...
  public String toString() {
    return "DetailTaxRetentionsRequest{" + "omit: " + omit + ", fields: " + fields + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(DetailTaxRetentionsRequest other) {
      omit(other.getOmit());
    ...
    public DetailTaxRetentionsRequest build() {
      return new DetailTaxRetentionsRequest(omit, fields);
    }
  }
}

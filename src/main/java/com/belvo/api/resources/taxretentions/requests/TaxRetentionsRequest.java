...
import com.belvo.api.types.EnumTaxRetentionType;
...
@JsonDeserialize(
    builder = TaxRetentionsRequest.Builder.class
)
public final class TaxRetentionsRequest {
  ...
  private final EnumTaxRetentionType type;
  ...
  TaxRetentionsRequest(Optional<String> omit, Optional<String> fields, String link, String dateFrom,
      String dateTo, EnumTaxRetentionType type, Optional<Boolean> attachXml,
  ...
  /**
   * @return The date from which you want to start getting tax retentions for, in <code>YYYY-MM-DD</code> format.
  ...
  /**
   * @return The date you want to stop getting tax retentions for, in <code>YYYY-MM-DD</code> format.
  ...
  /**
   * @return When set to <code>true</code>, you will receive the XML tax retention in the response.
   */
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof TaxRetentionsRequest && equalTo((TaxRetentionsRequest) other);
  }

  private boolean equalTo(TaxRetentionsRequest other) {
  ...
  public String toString() {
    return "TaxRetentionsRequest{" + "omit: " + omit + ", fields: " + fields + ", link: " + link + ", dateFrom: " + dateFrom + ", dateTo: " + dateTo + ", type: " + type + ", attachXml: " + attachXml + ", saveData: " + saveData + "}";
  }
  ...
  public interface LinkStage {
    ...
    Builder from(TaxRetentionsRequest other);
  }
  ...
  public interface DateToStage {
    TypeStage dateTo(String dateTo);
  }

  public interface TypeStage {
    _FinalStage type(EnumTaxRetentionType type);
  }

  public interface _FinalStage {
    TaxRetentionsRequest build();
  ...
  public static final class Builder implements LinkStage, DateFromStage, DateToStage, TypeStage, _FinalStage {
    private String link;
    ...
    @Override
    public Builder from(TaxRetentionsRequest other) {
      omit(other.getOmit());
    ...
    /**
     * <p>The date from which you want to start getting tax retentions for, in <code>YYYY-MM-DD</code> format.</p>
     * <p>⚠️ The value of <code>date_from</code> cannot be greater than <code>date_to</code>.</p>
     * @return Reference to {@code this} so that method calls can be chained together.
     */
    @Override
    ...
    /**
     * <p>The date you want to stop getting tax retentions for, in <code>YYYY-MM-DD</code> format.</p>
     * <p>⚠️ The number of days between <code>date_from</code> and <code>date_to</code> cannot be over 365.</p>
     * @return Reference to {@code this} so that method calls can be chained together.
     */
    @Override
    @JsonSetter("date_to")
    public TypeStage dateTo(String dateTo) {
      this.dateTo = dateTo;
      return this;
    }
    ...
    @Override
    @JsonSetter("type")
    public _FinalStage type(EnumTaxRetentionType type) {
      this.type = type;
      return this;
    }
    ...
    /**
     * <p>When set to <code>true</code>, you will receive the XML tax retention in the response.</p>
     * @return Reference to {@code this} so that method calls can be chained together.
     */
    @Override
    ...
    @Override
    public TaxRetentionsRequest build() {
      return new TaxRetentionsRequest(omit, fields, link, dateFrom, dateTo, type, attachXml, saveData);
    }
  }
}

...
@JsonDeserialize(
    builder = TaxComplianceStatusRequest.Builder.class
)
public final class TaxComplianceStatusRequest {
  ...
  TaxComplianceStatusRequest(Optional<String> omit, Optional<String> fields, String link,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof TaxComplianceStatusRequest && equalTo((TaxComplianceStatusRequest) other);
  }

  private boolean equalTo(TaxComplianceStatusRequest other) {
  ...
  public String toString() {
    return "TaxComplianceStatusRequest{" + "omit: " + omit + ", fields: " + fields + ", link: " + link + ", attachPdf: " + attachPdf + ", saveData: " + saveData + "}";
  }
  ...
  public interface LinkStage {
    ...
    Builder from(TaxComplianceStatusRequest other);
  }

  public interface _FinalStage {
    TaxComplianceStatusRequest build();
  ...
  public static final class Builder implements LinkStage, _FinalStage {
    ...
    @Override
    public Builder from(TaxComplianceStatusRequest other) {
      omit(other.getOmit());
    ...
    @Override
    public TaxComplianceStatusRequest build() {
      return new TaxComplianceStatusRequest(omit, fields, link, attachPdf, saveData);
    }
  }
}

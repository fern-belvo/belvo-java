...
@JsonDeserialize(
    builder = DetailIncomeRequest.Builder.class
)
public final class DetailIncomeRequest {
  ...
  DetailIncomeRequest(Optional<String> omit, Optional<String> fields) {
    this.omit = omit;
    this.fields = fields;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DetailIncomeRequest && equalTo((DetailIncomeRequest) other);
  }

  private boolean equalTo(DetailIncomeRequest other) {
  ...
  public String toString() {
    return "DetailIncomeRequest{" + "omit: " + omit + ", fields: " + fields + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(DetailIncomeRequest other) {
      omit(other.getOmit());
    ...
    public DetailIncomeRequest build() {
      return new DetailIncomeRequest(omit, fields);
    }
  }
}

...
@JsonDeserialize(
    builder = RetrieveOwnersRequest.Builder.class
)
public final class RetrieveOwnersRequest {
  ...
  RetrieveOwnersRequest(Optional<String> omit, Optional<String> fields, StandardRequest body) {
    this.omit = omit;
    this.fields = fields;
    this.body = body;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof RetrieveOwnersRequest && equalTo((RetrieveOwnersRequest) other);
  }

  private boolean equalTo(RetrieveOwnersRequest other) {
  ...
  public String toString() {
    return "RetrieveOwnersRequest{" + "omit: " + omit + ", fields: " + fields + ", body: " + body + "}";
  }
  ...
  public interface BodyStage {
    ...
    Builder from(RetrieveOwnersRequest other);
  }

  public interface _FinalStage {
    RetrieveOwnersRequest build();
  ...
  public static final class Builder implements BodyStage, _FinalStage {
    ...
    @Override
    public Builder from(RetrieveOwnersRequest other) {
      omit(other.getOmit());
    ...
    @Override
    public RetrieveOwnersRequest build() {
      return new RetrieveOwnersRequest(omit, fields, body);
    }
  }
}

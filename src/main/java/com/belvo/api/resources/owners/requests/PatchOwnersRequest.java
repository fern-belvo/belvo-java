...
@JsonDeserialize(
    builder = PatchOwnersRequest.Builder.class
)
public final class PatchOwnersRequest {
  ...
  PatchOwnersRequest(Optional<String> omit, Optional<String> fields, PatchBody body) {
    this.omit = omit;
    this.fields = fields;
    this.body = body;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PatchOwnersRequest && equalTo((PatchOwnersRequest) other);
  }

  private boolean equalTo(PatchOwnersRequest other) {
  ...
  public String toString() {
    return "PatchOwnersRequest{" + "omit: " + omit + ", fields: " + fields + ", body: " + body + "}";
  }
  ...
  public interface BodyStage {
    ...
    Builder from(PatchOwnersRequest other);
  }

  public interface _FinalStage {
    PatchOwnersRequest build();
  ...
  public static final class Builder implements BodyStage, _FinalStage {
    ...
    @Override
    public Builder from(PatchOwnersRequest other) {
      omit(other.getOmit());
    ...
    @Override
    public PatchOwnersRequest build() {
      return new PatchOwnersRequest(omit, fields, body);
    }
  }
}

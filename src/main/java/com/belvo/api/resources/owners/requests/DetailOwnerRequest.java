...
@JsonDeserialize(
    builder = DetailOwnerRequest.Builder.class
)
public final class DetailOwnerRequest {
  ...
  DetailOwnerRequest(Optional<String> omit, Optional<String> fields) {
    this.omit = omit;
    this.fields = fields;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DetailOwnerRequest && equalTo((DetailOwnerRequest) other);
  }

  private boolean equalTo(DetailOwnerRequest other) {
  ...
  public String toString() {
    return "DetailOwnerRequest{" + "omit: " + omit + ", fields: " + fields + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(DetailOwnerRequest other) {
      omit(other.getOmit());
    ...
    public DetailOwnerRequest build() {
      return new DetailOwnerRequest(omit, fields);
    }
  }
}

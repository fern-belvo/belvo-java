...
@JsonDeserialize(
    builder = EmploymentRecordRequest.Builder.class
)
public final class EmploymentRecordRequest {
  ...
  EmploymentRecordRequest(Optional<String> omit, Optional<String> fields, String link,
  ...
  /**
   * @return The <code>link.id</code> you want to retrieve employment records for.
   */
  @JsonProperty("link")
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof EmploymentRecordRequest && equalTo((EmploymentRecordRequest) other);
  }

  private boolean equalTo(EmploymentRecordRequest other) {
  ...
  public String toString() {
    return "EmploymentRecordRequest{" + "omit: " + omit + ", fields: " + fields + ", link: " + link + ", attachPdf: " + attachPdf + ", saveData: " + saveData + "}";
  }
  ...
  public interface LinkStage {
    ...
    Builder from(EmploymentRecordRequest other);
  }

  public interface _FinalStage {
    EmploymentRecordRequest build();
  ...
  public static final class Builder implements LinkStage, _FinalStage {
    ...
    @Override
    public Builder from(EmploymentRecordRequest other) {
      omit(other.getOmit());
    ...
    /**
     * <p>The <code>link.id</code> you want to retrieve employment records for.</p>
    ...
    @Override
    public EmploymentRecordRequest build() {
      return new EmploymentRecordRequest(omit, fields, link, attachPdf, saveData);
    }
  }
}

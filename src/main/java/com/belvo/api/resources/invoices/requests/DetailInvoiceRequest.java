...
@JsonDeserialize(
    builder = DetailInvoiceRequest.Builder.class
)
public final class DetailInvoiceRequest {
  ...
  DetailInvoiceRequest(Optional<String> omit, Optional<String> fields) {
    this.omit = omit;
    this.fields = fields;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DetailInvoiceRequest && equalTo((DetailInvoiceRequest) other);
  }

  private boolean equalTo(DetailInvoiceRequest other) {
  ...
  public String toString() {
    return "DetailInvoiceRequest{" + "omit: " + omit + ", fields: " + fields + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(DetailInvoiceRequest other) {
      omit(other.getOmit());
    ...
    public DetailInvoiceRequest build() {
      return new DetailInvoiceRequest(omit, fields);
    }
  }
}

...
@JsonDeserialize(
    builder = PatchInvoicesRequest.Builder.class
)
public final class PatchInvoicesRequest {
  ...
  PatchInvoicesRequest(Optional<String> omit, Optional<String> fields, PatchBody body) {
    this.omit = omit;
    this.fields = fields;
    this.body = body;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PatchInvoicesRequest && equalTo((PatchInvoicesRequest) other);
  }

  private boolean equalTo(PatchInvoicesRequest other) {
  ...
  public String toString() {
    return "PatchInvoicesRequest{" + "omit: " + omit + ", fields: " + fields + ", body: " + body + "}";
  }
  ...
  public interface BodyStage {
    ...
    Builder from(PatchInvoicesRequest other);
  }

  public interface _FinalStage {
    PatchInvoicesRequest build();
  ...
  public static final class Builder implements BodyStage, _FinalStage {
    ...
    @Override
    public Builder from(PatchInvoicesRequest other) {
      omit(other.getOmit());
    ...
    @Override
    public PatchInvoicesRequest build() {
      return new PatchInvoicesRequest(omit, fields, body);
    }
  }
}

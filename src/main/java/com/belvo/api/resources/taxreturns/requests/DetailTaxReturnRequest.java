...
@JsonDeserialize(
    builder = DetailTaxReturnRequest.Builder.class
)
public final class DetailTaxReturnRequest {
  ...
  DetailTaxReturnRequest(Optional<String> omit, Optional<String> fields) {
    this.omit = omit;
    this.fields = fields;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DetailTaxReturnRequest && equalTo((DetailTaxReturnRequest) other);
  }

  private boolean equalTo(DetailTaxReturnRequest other) {
  ...
  public String toString() {
    return "DetailTaxReturnRequest{" + "omit: " + omit + ", fields: " + fields + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(DetailTaxReturnRequest other) {
      omit(other.getOmit());
    ...
    public DetailTaxReturnRequest build() {
      return new DetailTaxReturnRequest(omit, fields);
    }
  }
}

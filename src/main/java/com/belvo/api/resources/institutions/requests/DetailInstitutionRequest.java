...
@JsonDeserialize(
    builder = DetailInstitutionRequest.Builder.class
)
public final class DetailInstitutionRequest {
  ...
  DetailInstitutionRequest(Optional<String> omit, Optional<String> fields) {
    this.omit = omit;
    this.fields = fields;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DetailInstitutionRequest && equalTo((DetailInstitutionRequest) other);
  }

  private boolean equalTo(DetailInstitutionRequest other) {
  ...
  public String toString() {
    return "DetailInstitutionRequest{" + "omit: " + omit + ", fields: " + fields + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(DetailInstitutionRequest other) {
      omit(other.getOmit());
    ...
    public DetailInstitutionRequest build() {
      return new DetailInstitutionRequest(omit, fields);
    }
  }
}

...
@JsonDeserialize(
    builder = ListTaxStatusRequest.Builder.class
)
public final class ListTaxStatusRequest {
  ...
  ListTaxStatusRequest(Optional<Integer> page, Optional<Integer> pageSize, Optional<String> omit,
  ...
  /**
   * @return Return tax statuses that were last updated in Belvo's database after this date (<code>YYYY-MM-DD</code> or full <code>ISO-8601</code> timestamp).
   */
  ...
  /**
   * @return Return tax statuses that were last updated in Belvo's database after or on this date (<code>YYYY-MM-DD</code> or full <code>ISO-8601</code> timestamp).
   */
  ...
  /**
   * @return Return tax statuses that were last updated in Belvo's database before this date (<code>YYYY-MM-DD</code> or full <code>ISO-8601</code> timestamp).
   */
  ...
  /**
   * @return Return tax statuses that were last updated in Belvo's database before or on this date (<code>YYYY-MM-DD</code> or full <code>ISO-8601</code> timestamp).
   */
  ...
  /**
   * @return Return tax statuses that were last updated in Belvo's database between two dates (<code>YYYY-MM-DD</code> or full <code>ISO-8601</code> timestamp).
   */
  ...
  /**
   * @return Return information for this <code>tax-status.id</code>.
   */
  @JsonProperty("id")
  ...
  /**
   * @return Return information for these <code>tax-status.id</code>s.
   */
  @JsonProperty("id__in")
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ListTaxStatusRequest && equalTo((ListTaxStatusRequest) other);
  }

  private boolean equalTo(ListTaxStatusRequest other) {
    return page.equals(other.page) && pageSize.equals(other.pageSize) && omit.equals(other.omit) && fields.equals(other.fields) && link.equals(other.link) && createdAtGt.equals(other.createdAtGt) && createdAtGte.equals(other.createdAtGte) && createdAtLt.equals(other.createdAtLt) && createdAtLte.equals(other.createdAtLte) && createdAtRange.equals(other.createdAtRange) && id.equals(other.id) && idIn.equals(other.idIn) && linkIn.equals(other.linkIn);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.page, this.pageSize, this.omit, this.fields, this.link, this.createdAtGt, this.createdAtGte, this.createdAtLt, this.createdAtLte, this.createdAtRange, this.id, this.idIn, this.linkIn);
    }
  ...
  public String toString() {
    return "ListTaxStatusRequest{" + "page: " + page + ", pageSize: " + pageSize + ", omit: " + omit + ", fields: " + fields + ", link: " + link + ", createdAtGt: " + createdAtGt + ", createdAtGte: " + createdAtGte + ", createdAtLt: " + createdAtLt + ", createdAtLte: " + createdAtLte + ", createdAtRange: " + createdAtRange + ", id: " + id + ", idIn: " + idIn + ", linkIn: " + linkIn + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(ListTaxStatusRequest other) {
      page(other.getPage());
    ...
    public ListTaxStatusRequest build() {
      return new ListTaxStatusRequest(page, pageSize, omit, fields, link, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, id, idIn, linkIn);
    }
  }
}

...
@JsonDeserialize(
    builder = DetailTaxStatusRequest.Builder.class
)
public final class DetailTaxStatusRequest {
  ...
  DetailTaxStatusRequest(Optional<String> omit, Optional<String> fields) {
    this.omit = omit;
    this.fields = fields;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DetailTaxStatusRequest && equalTo((DetailTaxStatusRequest) other);
  }

  private boolean equalTo(DetailTaxStatusRequest other) {
  ...
  public String toString() {
    return "DetailTaxStatusRequest{" + "omit: " + omit + ", fields: " + fields + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(DetailTaxStatusRequest other) {
      omit(other.getOmit());
    ...
    public DetailTaxStatusRequest build() {
      return new DetailTaxStatusRequest(omit, fields);
    }
  }
}

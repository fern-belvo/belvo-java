...
@JsonDeserialize(
    builder = DetailTransactionRequest.Builder.class
)
public final class DetailTransactionRequest {
  ...
  DetailTransactionRequest(Optional<String> omit, Optional<String> fields) {
    this.omit = omit;
    this.fields = fields;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DetailTransactionRequest && equalTo((DetailTransactionRequest) other);
  }

  private boolean equalTo(DetailTransactionRequest other) {
  ...
  public String toString() {
    return "DetailTransactionRequest{" + "omit: " + omit + ", fields: " + fields + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(DetailTransactionRequest other) {
      omit(other.getOmit());
    ...
    public DetailTransactionRequest build() {
      return new DetailTransactionRequest(omit, fields);
    }
  }
}

...
@JsonDeserialize(
    builder = PatchTransactionsRequest.Builder.class
)
public final class PatchTransactionsRequest {
  ...
  PatchTransactionsRequest(Optional<String> omit, Optional<String> fields, PatchBody body) {
    this.omit = omit;
    this.fields = fields;
    this.body = body;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PatchTransactionsRequest && equalTo((PatchTransactionsRequest) other);
  }

  private boolean equalTo(PatchTransactionsRequest other) {
  ...
  public String toString() {
    return "PatchTransactionsRequest{" + "omit: " + omit + ", fields: " + fields + ", body: " + body + "}";
  }
  ...
  public interface BodyStage {
    ...
    Builder from(PatchTransactionsRequest other);
  }

  public interface _FinalStage {
    PatchTransactionsRequest build();
  ...
  public static final class Builder implements BodyStage, _FinalStage {
    ...
    @Override
    public Builder from(PatchTransactionsRequest other) {
      omit(other.getOmit());
    ...
    @Override
    public PatchTransactionsRequest build() {
      return new PatchTransactionsRequest(omit, fields, body);
    }
  }
}

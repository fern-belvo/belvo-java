...
@JsonDeserialize(
    builder = BalancesRequest.Builder.class
)
public final class BalancesRequest {
  ...
  BalancesRequest(Optional<String> omit, Optional<String> fields, String link,
      Optional<String> account, String dateFrom, String dateTo, Optional<String> token,
  ...
  /**
   * @return If provided, only balances matching this <code>account.id</code> are returned.
   */
  ...
  /**
   * @return Date from which you want to start receiving balances, in <code>YYYY-MM-DD</code> format.
  ...
  /**
   * @return Date that you want to stop receiving balances, in <code>YYYY-MM-DD</code> format.
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof BalancesRequest && equalTo((BalancesRequest) other);
  }

  private boolean equalTo(BalancesRequest other) {
    return omit.equals(other.omit) && fields.equals(other.fields) && link.equals(other.link) && account.equals(other.account) && dateFrom.equals(other.dateFrom) && dateTo.equals(other.dateTo) && token.equals(other.token) && saveData.equals(other.saveData);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.omit, this.fields, this.link, this.account, this.dateFrom, this.dateTo, this.token, this.saveData);
    }
  ...
  public String toString() {
    return "BalancesRequest{" + "omit: " + omit + ", fields: " + fields + ", link: " + link + ", account: " + account + ", dateFrom: " + dateFrom + ", dateTo: " + dateTo + ", token: " + token + ", saveData: " + saveData + "}";
  }
  ...
  public interface LinkStage {
    ...
    Builder from(BalancesRequest other);
  }
  ...
  public static final class Builder implements LinkStage, DateFromStage, DateToStage, _FinalStage {
    ...
    @Override
    public Builder from(BalancesRequest other) {
      omit(other.getOmit());
    ...
    /**
     * <p>Date from which you want to start receiving balances, in <code>YYYY-MM-DD</code> format.</p>
     * <p>⚠️ The value of <code>date_from</code> cannot be greater than <code>date_to</code>.</p>
     * @return Reference to {@code this} so that method calls can be chained together.
     */
    @Override
    ...
    /**
     * <p>Date that you want to stop receiving balances, in <code>YYYY-MM-DD</code> format.</p>
     * <p>⚠️ The value of <code>date_to</code> cannot be greater than today's date (in other words, no future dates).</p>
     * @return Reference to {@code this} so that method calls can be chained together.
     */
    @Override
    ...
    /**
     * <p>If provided, only balances matching this <code>account.id</code> are returned.</p>
     * @return Reference to {@code this} so that method calls can be chained together.
     */
    @Override
    ...
    @Override
    public BalancesRequest build() {
      return new BalancesRequest(omit, fields, link, account, dateFrom, dateTo, token, saveData);
    }
  }
}

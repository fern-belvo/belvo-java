...
@JsonDeserialize(
    builder = DetailBalanceRequest.Builder.class
)
public final class DetailBalanceRequest {
  ...
  DetailBalanceRequest(Optional<String> omit, Optional<String> fields) {
    this.omit = omit;
    this.fields = fields;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DetailBalanceRequest && equalTo((DetailBalanceRequest) other);
  }

  private boolean equalTo(DetailBalanceRequest other) {
  ...
  public String toString() {
    return "DetailBalanceRequest{" + "omit: " + omit + ", fields: " + fields + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(DetailBalanceRequest other) {
      omit(other.getOmit());
    ...
    public DetailBalanceRequest build() {
      return new DetailBalanceRequest(omit, fields);
    }
  }
}

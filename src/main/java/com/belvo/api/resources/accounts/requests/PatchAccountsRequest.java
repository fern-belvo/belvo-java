...
@JsonDeserialize(
    builder = PatchAccountsRequest.Builder.class
)
public final class PatchAccountsRequest {
  ...
  PatchAccountsRequest(Optional<String> omit, Optional<String> fields, PatchBody body) {
    this.omit = omit;
    this.fields = fields;
    this.body = body;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PatchAccountsRequest && equalTo((PatchAccountsRequest) other);
  }

  private boolean equalTo(PatchAccountsRequest other) {
  ...
  public String toString() {
    return "PatchAccountsRequest{" + "omit: " + omit + ", fields: " + fields + ", body: " + body + "}";
  }
  ...
  public interface BodyStage {
    ...
    Builder from(PatchAccountsRequest other);
  }

  public interface _FinalStage {
    PatchAccountsRequest build();
  ...
  public static final class Builder implements BodyStage, _FinalStage {
    ...
    @Override
    public Builder from(PatchAccountsRequest other) {
      omit(other.getOmit());
    ...
    @Override
    public PatchAccountsRequest build() {
      return new PatchAccountsRequest(omit, fields, body);
    }
  }
}

...
@JsonDeserialize(
    builder = DetailAccountRequest.Builder.class
)
public final class DetailAccountRequest {
  ...
  DetailAccountRequest(Optional<String> omit, Optional<String> fields) {
    this.omit = omit;
    this.fields = fields;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DetailAccountRequest && equalTo((DetailAccountRequest) other);
  }

  private boolean equalTo(DetailAccountRequest other) {
  ...
  public String toString() {
    return "DetailAccountRequest{" + "omit: " + omit + ", fields: " + fields + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(DetailAccountRequest other) {
      omit(other.getOmit());
    ...
    public DetailAccountRequest build() {
      return new DetailAccountRequest(omit, fields);
    }
  }
}

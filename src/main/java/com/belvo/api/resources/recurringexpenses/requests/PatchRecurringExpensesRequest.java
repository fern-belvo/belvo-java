...
@JsonDeserialize(
    builder = PatchRecurringExpensesRequest.Builder.class
)
public final class PatchRecurringExpensesRequest {
  ...
  PatchRecurringExpensesRequest(Optional<String> omit, Optional<String> fields, PatchBody body) {
    this.omit = omit;
    this.fields = fields;
    this.body = body;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PatchRecurringExpensesRequest && equalTo((PatchRecurringExpensesRequest) other);
  }

  private boolean equalTo(PatchRecurringExpensesRequest other) {
  ...
  public String toString() {
    return "PatchRecurringExpensesRequest{" + "omit: " + omit + ", fields: " + fields + ", body: " + body + "}";
  }
  ...
  public interface BodyStage {
    ...
    Builder from(PatchRecurringExpensesRequest other);
  }

  public interface _FinalStage {
    PatchRecurringExpensesRequest build();
  ...
  public static final class Builder implements BodyStage, _FinalStage {
    ...
    @Override
    public Builder from(PatchRecurringExpensesRequest other) {
      omit(other.getOmit());
    ...
    @Override
    public PatchRecurringExpensesRequest build() {
      return new PatchRecurringExpensesRequest(omit, fields, body);
    }
  }
}

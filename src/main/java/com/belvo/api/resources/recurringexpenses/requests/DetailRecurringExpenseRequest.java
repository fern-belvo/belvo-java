...
@JsonDeserialize(
    builder = DetailRecurringExpenseRequest.Builder.class
)
public final class DetailRecurringExpenseRequest {
  ...
  DetailRecurringExpenseRequest(Optional<String> omit, Optional<String> fields) {
    this.omit = omit;
    this.fields = fields;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DetailRecurringExpenseRequest && equalTo((DetailRecurringExpenseRequest) other);
  }

  private boolean equalTo(DetailRecurringExpenseRequest other) {
  ...
  public String toString() {
    return "DetailRecurringExpenseRequest{" + "omit: " + omit + ", fields: " + fields + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(DetailRecurringExpenseRequest other) {
      omit(other.getOmit());
    ...
    public DetailRecurringExpenseRequest build() {
      return new DetailRecurringExpenseRequest(omit, fields);
    }
  }
}

package com.belvo.api.resources.investmentportfolios.requests;

import com.belvo.api.types.PatchBodyWithoutSaveData;
...
@JsonDeserialize(
    builder = PatchPortfolioRequest.Builder.class
)
public final class PatchPortfolioRequest {
  private final Optional<String> omit;

  private final Optional<String> fields;

  private final PatchBodyWithoutSaveData body;

  private int _cachedHashCode;

  PatchPortfolioRequest(Optional<String> omit, Optional<String> fields,
      PatchBodyWithoutSaveData body) {
    this.omit = omit;
    this.fields = fields;
    this.body = body;
  }
   ...
   */
  @JsonProperty("body")
  public PatchBodyWithoutSaveData getBody() {
    return body;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PatchPortfolioRequest && equalTo((PatchPortfolioRequest) other);
  }

  private boolean equalTo(PatchPortfolioRequest other) {
  ...
  public String toString() {
    return "PatchPortfolioRequest{" + "omit: " + omit + ", fields: " + fields + ", body: " + body + "}";
  }
  ...
  public interface BodyStage {
    _FinalStage body(PatchBodyWithoutSaveData body);

    Builder from(PatchPortfolioRequest other);
  }

  public interface _FinalStage {
    PatchPortfolioRequest build();
  ...
  public static final class Builder implements BodyStage, _FinalStage {
    private PatchBodyWithoutSaveData body;
    ...
    @Override
    public Builder from(PatchPortfolioRequest other) {
      omit(other.getOmit());
    ...
    @Override
    @JsonSetter("body")
    public _FinalStage body(PatchBodyWithoutSaveData body) {
      this.body = body;
      return this;
    }
    ...
    public PatchPortfolioRequest build() {
      return new PatchPortfolioRequest(omit, fields, body);
    }
  }
}

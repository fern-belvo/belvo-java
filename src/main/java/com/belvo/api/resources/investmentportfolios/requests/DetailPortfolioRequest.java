...
@JsonDeserialize(
    builder = DetailPortfolioRequest.Builder.class
)
public final class DetailPortfolioRequest {
  ...
  DetailPortfolioRequest(Optional<String> omit, Optional<String> fields) {
    this.omit = omit;
    this.fields = fields;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DetailPortfolioRequest && equalTo((DetailPortfolioRequest) other);
  }

  private boolean equalTo(DetailPortfolioRequest other) {
  ...
  public String toString() {
    return "DetailPortfolioRequest{" + "omit: " + omit + ", fields: " + fields + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(DetailPortfolioRequest other) {
      omit(other.getOmit());
    ...
    public DetailPortfolioRequest build() {
      return new DetailPortfolioRequest(omit, fields);
    }
  }
}

...
@JsonDeserialize(
    builder = ListPortfolioRequest.Builder.class
)
public final class ListPortfolioRequest {
  ...
  ListPortfolioRequest(Optional<Integer> page, Optional<Integer> pageSize, Optional<String> omit,
      ...
      Optional<String> createdAtRange, Optional<String> linkIn) {
    this.page = page;
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ListPortfolioRequest && equalTo((ListPortfolioRequest) other);
  }

  private boolean equalTo(ListPortfolioRequest other) {
  ...
  public String toString() {
    return "ListPortfolioRequest{" + "page: " + page + ", pageSize: " + pageSize + ", omit: " + omit + ", fields: " + fields + ", link: " + link + ", createdAtGt: " + createdAtGt + ", createdAtGte: " + createdAtGte + ", createdAtLt: " + createdAtLt + ", createdAtLte: " + createdAtLte + ", createdAtRange: " + createdAtRange + ", linkIn: " + linkIn + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(ListPortfolioRequest other) {
      page(other.getPage());
    ...
    public ListPortfolioRequest build() {
      return new ListPortfolioRequest(page, pageSize, omit, fields, link, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, linkIn);
    }
  }
}

...
@JsonDeserialize(
    builder = RetrievePortfolioRequest.Builder.class
)
public final class RetrievePortfolioRequest {
  ...
  RetrievePortfolioRequest(Optional<String> omit, Optional<String> fields, StandardRequest body) {
    this.omit = omit;
    this.fields = fields;
    this.body = body;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof RetrievePortfolioRequest && equalTo((RetrievePortfolioRequest) other);
  }

  private boolean equalTo(RetrievePortfolioRequest other) {
  ...
  public String toString() {
    return "RetrievePortfolioRequest{" + "omit: " + omit + ", fields: " + fields + ", body: " + body + "}";
  }
  ...
  public interface BodyStage {
    ...
    Builder from(RetrievePortfolioRequest other);
  }

  public interface _FinalStage {
    RetrievePortfolioRequest build();
  ...
  public static final class Builder implements BodyStage, _FinalStage {
    ...
    @Override
    public Builder from(RetrievePortfolioRequest other) {
      omit(other.getOmit());
    ...
    @Override
    public RetrievePortfolioRequest build() {
      return new RetrievePortfolioRequest(omit, fields, body);
    }
  }
}

...
@JsonDeserialize(
    builder = ListRiskInsightsRequest.Builder.class
)
public final class ListRiskInsightsRequest {
  ...
  ListRiskInsightsRequest(Optional<Integer> page, Optional<Integer> pageSize, Optional<String> omit,
      Optional<String> fields, Optional<String> link, Optional<String> id, Optional<String> idIn,
  ...
  /**
   * @return Return information for this <code>risk-insight.id</code>.
   */
  @JsonProperty("id")
  ...
  /**
   * @return Return information for these <code>risk-insight.id</code>s.
   */
  @JsonProperty("id__in")
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ListRiskInsightsRequest && equalTo((ListRiskInsightsRequest) other);
  }

  private boolean equalTo(ListRiskInsightsRequest other) {
    return page.equals(other.page) && pageSize.equals(other.pageSize) && omit.equals(other.omit) && fields.equals(other.fields) && link.equals(other.link) && id.equals(other.id) && idIn.equals(other.idIn) && linkIn.equals(other.linkIn);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.page, this.pageSize, this.omit, this.fields, this.link, this.id, this.idIn, this.linkIn);
    }
  ...
  public String toString() {
    return "ListRiskInsightsRequest{" + "page: " + page + ", pageSize: " + pageSize + ", omit: " + omit + ", fields: " + fields + ", link: " + link + ", id: " + id + ", idIn: " + idIn + ", linkIn: " + linkIn + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(ListRiskInsightsRequest other) {
      page(other.getPage());
    ...
    public ListRiskInsightsRequest build() {
      return new ListRiskInsightsRequest(page, pageSize, omit, fields, link, id, idIn, linkIn);
    }
  }
}

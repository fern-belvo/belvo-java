...
@JsonDeserialize(
    builder = PatchRiskInsightsRequest.Builder.class
)
public final class PatchRiskInsightsRequest {
  ...
  PatchRiskInsightsRequest(Optional<String> omit, Optional<String> fields, PatchBody body) {
    this.omit = omit;
    this.fields = fields;
    this.body = body;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PatchRiskInsightsRequest && equalTo((PatchRiskInsightsRequest) other);
  }

  private boolean equalTo(PatchRiskInsightsRequest other) {
  ...
  public String toString() {
    return "PatchRiskInsightsRequest{" + "omit: " + omit + ", fields: " + fields + ", body: " + body + "}";
  }
  ...
  public interface BodyStage {
    ...
    Builder from(PatchRiskInsightsRequest other);
  }

  public interface _FinalStage {
    PatchRiskInsightsRequest build();
  ...
  public static final class Builder implements BodyStage, _FinalStage {
    ...
    @Override
    public Builder from(PatchRiskInsightsRequest other) {
      omit(other.getOmit());
    ...
    @Override
    public PatchRiskInsightsRequest build() {
      return new PatchRiskInsightsRequest(omit, fields, body);
    }
  }
}

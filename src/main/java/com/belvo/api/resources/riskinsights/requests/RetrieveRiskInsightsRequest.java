...
@JsonDeserialize(
    builder = RetrieveRiskInsightsRequest.Builder.class
)
public final class RetrieveRiskInsightsRequest {
  ...
  RetrieveRiskInsightsRequest(Optional<String> omit, Optional<String> fields,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof RetrieveRiskInsightsRequest && equalTo((RetrieveRiskInsightsRequest) other);
  }

  private boolean equalTo(RetrieveRiskInsightsRequest other) {
  ...
  public String toString() {
    return "RetrieveRiskInsightsRequest{" + "omit: " + omit + ", fields: " + fields + ", body: " + body + "}";
  }
  ...
  public interface BodyStage {
    ...
    Builder from(RetrieveRiskInsightsRequest other);
  }

  public interface _FinalStage {
    RetrieveRiskInsightsRequest build();
  ...
  public static final class Builder implements BodyStage, _FinalStage {
    ...
    @Override
    public Builder from(RetrieveRiskInsightsRequest other) {
      omit(other.getOmit());
    ...
    @Override
    public RetrieveRiskInsightsRequest build() {
      return new RetrieveRiskInsightsRequest(omit, fields, body);
    }
  }
}

...
@JsonDeserialize(
    builder = PatchLinksRequest.Builder.class
)
public final class PatchLinksRequest {
  ...
  PatchLinksRequest(Optional<String> omit, Optional<String> fields, PatchBodyWithoutSaveData body) {
    this.omit = omit;
    this.fields = fields;
    this.body = body;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PatchLinksRequest && equalTo((PatchLinksRequest) other);
  }

  private boolean equalTo(PatchLinksRequest other) {
  ...
  public String toString() {
    return "PatchLinksRequest{" + "omit: " + omit + ", fields: " + fields + ", body: " + body + "}";
  }
  ...
  public interface BodyStage {
    ...
    Builder from(PatchLinksRequest other);
  }

  public interface _FinalStage {
    PatchLinksRequest build();
  ...
  public static final class Builder implements BodyStage, _FinalStage {
    ...
    @Override
    public Builder from(PatchLinksRequest other) {
      omit(other.getOmit());
    ...
    @Override
    public PatchLinksRequest build() {
      return new PatchLinksRequest(omit, fields, body);
    }
  }
}
